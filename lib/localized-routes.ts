...
export const localizedRoutes = {
  home: { fr: "/", en: "/en" },
  airportTransfer: { fr: "/transfert-aeroport-dakar", en: null },
  businessChauffeur: { fr: "/chauffeur-prive-business-dakar", en: null },
  electricChauffeur: { fr: "/vtc-voiture-electrique-dakar", en: null },
